...
(🟢 done / 🟡 active / ⚪ skipped·pending; auto-hidden when no wi is running). <!-- aitaste:allow U+1F7E2 U+1F7E1 U+26AA: the exact glyphs bin/pf-chain-render.cjs renders in the statusline; this line mirrors real output -->
