...
var k12Ledger = map[string]cardclaims.Census{
	...
	"pf_recall":                  {Candidates: 50, Cited: 40, QuotePinned: 0, Unclassified: 0, PendingImplementation: 0, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 10},
