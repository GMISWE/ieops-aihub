...
var k12Cards = []string{
	...
	// aihub#708 Batch 2A — the WI-owned workflow surface. Every claim on these
	// cards cites internal/domain/workflow_db_test.go's arms or carries a
	// prose-only marker; they enter the roster with Unclassified 0 by
	// construction, in the same change that added them.
	"pf_get_workflow",
	"pf_update_workflow",
...
//
// pf_recall was re-pinned again 60/49/prose-only 11 -> 65/53/prose-only 12 by
// aihub#669 on 2026-09-14, and the finding was RECLASSIFIED rather than
// DEBT_GROWTH: Unclassified was 0 before and is 0 after. 5 assertable sentences
// arrived with the instruct-prefix bullet in hop 4. 4 of them cite an arm in
// internal/domain/embed_query_prefix_test.go or the read-site exemption in
// internal/domain/embed_writer_parity_test.go. The 5th says the prefix lowers
// every similarity and that the lowest real query of the 44 clears the garbage
// control by 0.0607, and it carries prose-only because=measurement, which is
// that vocabulary entry's own definition ("a number with a unit plus a corpus or
// a date") rather than a relabel between waiver kinds. Three neighbouring
// sentences in the same bullet are pure readings that the recogniser does not
// call candidate-assertable, so they carry no marker: a marker there is a
// STALE_MARKER finding, which is how this was measured rather than guessed.
var k12Ledger = map[string]cardclaims.Census{
	...
	"pf_commit":                  {Candidates: 14, Cited: 12, QuotePinned: 0, Unclassified: 0, PendingImplementation: 0, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 2},
	"pf_complete_attempt":        {Candidates: 38, Cited: 38, QuotePinned: 0, Unclassified: 0, PendingImplementation: 0, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 0},
	...
	// are Batch 2B's parity fixtures, each marker citing aihub#708.
	"pf_get_workflow":        {Candidates: 12, Cited: 6, QuotePinned: 0, Unclassified: 0, PendingImplementation: 4, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 2},
	"pf_update_workflow":     {Candidates: 12, Cited: 8, QuotePinned: 0, Unclassified: 0, PendingImplementation: 4, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 0},
	"pf_start_workflow_step": {Candidates: 8, Cited: 4, QuotePinned: 0, Unclassified: 0, PendingImplementation: 3, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 1},
	"pf_workflow_result":     {Candidates: 7, Cited: 4, QuotePinned: 0, Unclassified: 0, PendingImplementation: 1, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 2},
	"pf_approve_workflow":    {Candidates: 8, Cited: 6, QuotePinned: 0, Unclassified: 0, PendingImplementation: 2, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 0},
	"pf_repair_workflow":     {Candidates: 10, Cited: 6, QuotePinned: 0, Unclassified: 0, PendingImplementation: 4, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 0},
	// aihub#708 B3 — the reconcile card enters with Unclassified 0 by the
	// same construction: every assertable sentence cites a
	...
	"pf_wrap":              {Candidates: 9, Cited: 9, QuotePinned: 0, Unclassified: 0, PendingImplementation: 0, KnownDefect: 0, StructurallyUnreachable: 0, AcceptedUnprobed: 0, ProseOnly: 0},
}
