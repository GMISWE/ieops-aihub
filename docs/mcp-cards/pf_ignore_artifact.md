# pf_ignore_artifact — contract card

```json
{
  "tool": "pf_ignore_artifact",
  "description_sha256": "3af5d0d558f2250861da3e3f8d4d138e0b54e0aeaba46756fd135b2c116dbe9c",
...
It writes one `artifact_action` event with `action: "ignore"`. **No artifact row changes state**: the event
