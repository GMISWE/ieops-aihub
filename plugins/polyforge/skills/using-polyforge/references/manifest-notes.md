...
**What this does not establish.** The session-start arm alone cannot distinguish "never
...
THE VALUE IS NOT RECORDED HERE ANY MORE - only how to get it:
...
fragments/on-demand-index.md). Rationale per fragment:
  ...
  fragments/memory-conventions.md    4,841 chars - its load-bearing rule ("all memory
                                     ...
                                     This fragment used to be justified partly by
  ...
  fragments/platform-adaptation.md   1,425 chars - its most load-bearing fact, the
                                     ...
                                     What does NOT survive is "there is no `Skill`
...
One restatement is left standing, deliberately: docs/using-polyforge.md:55-57 describes
