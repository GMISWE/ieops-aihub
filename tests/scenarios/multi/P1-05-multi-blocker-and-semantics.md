...
AS ADMIN: pf_create_dependency(blocked_wi_id=WI_C, blocking_wi_id=WI_A, kind="blocks")
AS ADMIN: pf_create_dependency(blocked_wi_id=WI_C, blocking_wi_id=WI_B, kind="blocks")
